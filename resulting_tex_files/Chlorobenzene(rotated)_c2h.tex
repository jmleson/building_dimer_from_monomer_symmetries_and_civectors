...
monomer ci vectors:
$$\begin{array}{c}
+\left|\underbrace{(b_2^{l})^{2}(b_2^{*l})^{0}(a_2^{l})^{2}(a_2^{*l})^{0}}_{a_{g}^{l}}\right| \otimes{} \left|\underbrace{(b_2^{r})^{1}(b_2^{*r})^{1}(a_2^{r})^{1}(a_2^{*r})^{1}}_{a_1^{r}}\right| +\left|\underbrace{(b_2^{l})^{1}(b_2^{*l})^{1}(a_2^{l})^{1}(a_2^{*l})^{1}}_{a_1^{l}}\right| \otimes{} \left|\underbrace{(b_2^{r})^{2}(b_2^{*r})^{0}(a_2^{r})^{2}(a_2^{*r})^{0}}_{a_{g}^{r}}\right|
\end{array}$$substitution by dimer orbitals:
$$+\left|\underbrace{(+a_{g}+b_u)^{2}(+a_g^{*}+b_u^{*})^{0}(+a_{u}+b_g)^{2}(+a_u^{*}+b_g^{*})^{0}}_{a_{g}^{l}}\right| \otimes{} \left|\underbrace{(-a_{g}+b_u)^{1}(-a_g^{*}+b_u^{*})^{1}(+a_{u}-b_g)^{1}(+a_u^{*}-b_g^{*})^{1}}_{a_1^{r}}\right| + \hdots $$(multiplied out and summed up) dimer ci vectors:
...
\end{array}$$substitution by dimer orbitals:
$$+\left|\underbrace{(+a_{g}+b_u)^{1}(+a_g^{*}+b_u^{*})^{1}(+a_{u}+b_g)^{2}(+a_u^{*}+b_g^{*})^{0}}_{a_1^{l}}\right| \otimes{} \left|\underbrace{(-a_{g}+b_u)^{1}(-a_g^{*}+b_u^{*})^{1}(+a_{u}-b_g)^{2}(+a_u^{*}-b_g^{*})^{0}}_{a_1^{r}}\right| + \hdots $$(multiplied out and summed up) dimer ci vectors:
...
\end{array}$$substitution by dimer orbitals:
$$+\left|\underbrace{(+a_{g}+b_u)^{1}(+a_g^{*}+b_u^{*})^{1}(+a_{u}+b_g)^{2}(+a_u^{*}+b_g^{*})^{0}}_{a_1^{l}}\right| \otimes{} \left|\underbrace{(-a_{g}+b_u)^{2}(-a_g^{*}+b_u^{*})^{1}(+a_{u}-b_g)^{1}(+a_u^{*}-b_g^{*})^{0}}_{b_1^{r}}\right| + \hdots $$(multiplied out and summed up) dimer ci vectors:
...
\end{array}$$substitution by dimer orbitals:
$$+\left|\underbrace{(+a_{g}+b_u)^{2}(+a_g^{*}+b_u^{*})^{1}(+a_{u}+b_g)^{1}(+a_u^{*}+b_g^{*})^{0}}_{b_1^{l}}\right| \otimes{} \left|\underbrace{(-a_{g}+b_u)^{2}(-a_g^{*}+b_u^{*})^{1}(+a_{u}-b_g)^{1}(+a_u^{*}-b_g^{*})^{0}}_{b_1^{r}}\right| + \hdots $$(multiplied out and summed up) dimer ci vectors:
