...
monomer ci vectors:
$$\begin{array}{c}
+\left|\underbrace{(b_2^{\mathsf{l}})^{2}(b_2^{*l})^{0}(a_2^{\mathsf{l}})^{2}(a_2^{*l})^{0}}_{a_{g}^{\mathsf{l}}}\right| \bullet{} \left|\underbrace{(b_2^{\mathsf{r}})^{1}(b_2^{*r})^{1}(a_2^{\mathsf{r}})^{1}(a_2^{*r})^{1}}_{a_1^{\mathsf{r}}}\right| +\left|\underbrace{(b_2^{\mathsf{l}})^{1}(b_2^{*l})^{1}(a_2^{\mathsf{l}})^{1}(a_2^{*l})^{1}}_{a_1^{\mathsf{l}}}\right| \bullet{} \left|\underbrace{(b_2^{\mathsf{r}})^{2}(b_2^{*r})^{0}(a_2^{\mathsf{r}})^{2}(a_2^{*r})^{0}}_{a_{g}^{\mathsf{r}}}\right|
\end{array}$$substitution by dimer orbitals:
$$+\left|\underbrace{(+a_{g}+b_u)^{2}(+a_g^{*}+b_u^{*})^{0}(+a_{u}+b_g)^{2}(+a_u^{*}+b_g^{*})^{0}}_{a_{g}^{\mathsf{l}}}\right| \bullet{} \left|\underbrace{(-a_{g}+b_u)^{1}(-a_g^{*}+b_u^{*})^{1}(+a_{u}-b_g)^{1}(+a_u^{*}-b_g^{*})^{1}}_{a_1^{\mathsf{r}}}\right| + \hdots $$(multiplied out and summed up) dimer ci vectors:
...
\end{array}$$substitution by dimer orbitals:
$$+\left|\underbrace{(+a_{g}+b_u)^{1}(+a_g^{*}+b_u^{*})^{1}(+a_{u}+b_g)^{2}(+a_u^{*}+b_g^{*})^{0}}_{a_1^{\mathsf{l}}}\right| \bullet{} \left|\underbrace{(-a_{g}+b_u)^{1}(-a_g^{*}+b_u^{*})^{1}(+a_{u}-b_g)^{2}(+a_u^{*}-b_g^{*})^{0}}_{a_1^{\mathsf{r}}}\right| + \hdots $$(multiplied out and summed up) dimer ci vectors:
...
\end{array}$$substitution by dimer orbitals:
$$+\left|\underbrace{(+a_{g}+b_u)^{1}(+a_g^{*}+b_u^{*})^{1}(+a_{u}+b_g)^{2}(+a_u^{*}+b_g^{*})^{0}}_{a_1^{\mathsf{l}}}\right| \bullet{} \left|\underbrace{(-a_{g}+b_u)^{2}(-a_g^{*}+b_u^{*})^{1}(+a_{u}-b_g)^{1}(+a_u^{*}-b_g^{*})^{0}}_{b_1^{\mathsf{r}}}\right| + \hdots $$(multiplied out and summed up) dimer ci vectors:
...
\end{array}$$substitution by dimer orbitals:
$$+\left|\underbrace{(+a_{g}+b_u)^{2}(+a_g^{*}+b_u^{*})^{1}(+a_{u}+b_g)^{1}(+a_u^{*}+b_g^{*})^{0}}_{b_1^{\mathsf{l}}}\right| \bullet{} \left|\underbrace{(-a_{g}+b_u)^{2}(-a_g^{*}+b_u^{*})^{1}(+a_{u}-b_g)^{1}(+a_u^{*}-b_g^{*})^{0}}_{b_1^{\mathsf{r}}}\right| + \hdots $$(multiplied out and summed up) dimer ci vectors:
...
$S \bullet Q - Q \bullet S \displaystyle $ & $b_u \displaystyle $ \\[0.1cm] 
$i^3 A_1 \bullet i^3 A_1 \displaystyle $ & $a_{g} \displaystyle $ \\[0.1cm] 
$i^3 A_1 \bullet e^3 A_1 + e^3 A_1 \bullet i^3 A_1 \displaystyle $ & $a_{g} \displaystyle $ \\[0.1cm] 
$i^3 A_1 \bullet e^3 A_1 - e^3 A_1 \bullet i^3 A_1 \displaystyle $ & $b_u \displaystyle $ \\[0.1cm] 
$i^3 A_1 \bullet i^3 B_{1} + i^3 B_{1} \bullet i^3 A_1 \displaystyle $ & $b_g \displaystyle $ \\[0.1cm] 
$i^3 A_1 \bullet i^3 B_{1} - i^3 B_{1} \bullet i^3 A_1 \displaystyle $ & $a_{u} \displaystyle $ \\[0.1cm] 
$i^3 A_1 \bullet i^3 B_{1} + i^3 B_{1} \bullet i^3 A_1 \displaystyle $ & $b_g \displaystyle $ \\[0.1cm] 
$i^3 A_1 \bullet i^3 B_{1} - i^3 B_{1} \bullet i^3 A_1 \displaystyle $ & $a_{u} \displaystyle $ \\[0.1cm] 
$e^3 A_1 \bullet e^3 A_1 \displaystyle $ & $a_{g} \displaystyle $ \\[0.1cm] 
$e^3 A_1 \bullet i^3 B_{1} + i^3 B_{1} \bullet e^3 A_1 \displaystyle $ & $b_g \displaystyle $ \\[0.1cm] 
$e^3 A_1 \bullet i^3 B_{1} - i^3 B_{1} \bullet e^3 A_1 \displaystyle $ & $a_{u} \displaystyle $ \\[0.1cm] 
$e^3 A_1 \bullet i^3 B_{1} + i^3 B_{1} \bullet e^3 A_1 \displaystyle $ & $b_g \displaystyle $ \\[0.1cm] 
$e^3 A_1 \bullet i^3 B_{1} - i^3 B_{1} \bullet e^3 A_1 \displaystyle $ & $a_{u} \displaystyle $ \\[0.1cm] 
$i^3 B_{1} \bullet i^3 B_{1} \displaystyle $ & $a_{g} \displaystyle $ \\[0.1cm] 
$i^3 B_{1} \bullet i^3 B_{1} + i^3 B_{1} \bullet i^3 B_{1} \displaystyle $ & $a_{g} \displaystyle $ \\[0.1cm] 
$i^3 B_{1} \bullet i^3 B_{1} \displaystyle $ & $a_{g} \displaystyle $ \\[0.1cm] 
\hline
\end{tabular}
\end{table}
...
$\Rightarrow{}$ 7x $a_{g}$ and 2x $b_u$ and 4x $b_g$ and 4x $a_{u}$
