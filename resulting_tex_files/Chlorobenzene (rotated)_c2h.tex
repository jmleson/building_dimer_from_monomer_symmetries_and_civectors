...
\draw[-> , thick] (0.35, -0.85) -- (0.35, -0.35); 
 \draw[-> , thick] (1.35, -0.85) -- (1.35, -0.35); 
\end{tikzpicture}}\right)\]enthaltene Monomer-Symmetrien = $a_1,a_{g}$\begin{multline*}=+\left(\left|(b_2^{l}) \cdot (b_2^{*l}) \cdot (a_2^{l}) \cdot (a_2^{*l})\right|\right)+\left(\left|(b_2^{r}) \cdot (b_2^{*r}) \cdot (a_2^{r}) \cdot (a_2^{*r})\right|\right)\end{multline*}
\begin{multline*}
...
plus combination: $i^3 a_1$ and $e^3 a_1$ + $e^3 a_1$ and $i^3 a_1$ \[ \begin{array}{c}+\left(\text{\begin{tikzpicture}
    % oberste MOs:
    \draw[thick] (0,0) -- (0.5,0); % erster Strich
    \draw[thick] (1,0) -- (1.5,0); % zweiter Strich
    % unterste MOs:
...
minus combination: $i^3 a_1$ and $e^3 a_1$ - $e^3 a_1$ and $i^3 a_1$ \[ \begin{array}{c}+\left(\text{\begin{tikzpicture}
    % oberste MOs:
    \draw[thick] (0,0) -- (0.5,0); % erster Strich
    \draw[thick] (1,0) -- (1.5,0); % zweiter Strich
    % unterste MOs:
...
plus combination: $i^3 a_1$ and $e^3 b_{1}$ + $e^3 b_{1}$ and $i^3 a_1$ \[ \begin{array}{c}+\left(\text{\begin{tikzpicture}
    % oberste MOs:
    \draw[thick] (0,0) -- (0.5,0); % erster Strich
    \draw[thick] (1,0) -- (1.5,0); % zweiter Strich
    % unterste MOs:
...
minus combination: $i^3 a_1$ and $e^3 b_{1}$ - $e^3 b_{1}$ and $i^3 a_1$ \[ \begin{array}{c}+\left(\text{\begin{tikzpicture}
    % oberste MOs:
    \draw[thick] (0,0) -- (0.5,0); % erster Strich
    \draw[thick] (1,0) -- (1.5,0); % zweiter Strich
    % unterste MOs:
...
plus combination: $i^3 a_1$ and $i^3 b_{1}$ + $i^3 b_{1}$ and $i^3 a_1$ \[ \begin{array}{c}+\left(\text{\begin{tikzpicture}
    % oberste MOs:
    \draw[thick] (0,0) -- (0.5,0); % erster Strich
    \draw[thick] (1,0) -- (1.5,0); % zweiter Strich
    % unterste MOs:
...
minus combination: $i^3 a_1$ and $i^3 b_{1}$ - $i^3 b_{1}$ and $i^3 a_1$ \[ \begin{array}{c}+\left(\text{\begin{tikzpicture}
    % oberste MOs:
    \draw[thick] (0,0) -- (0.5,0); % erster Strich
    \draw[thick] (1,0) -- (1.5,0); % zweiter Strich
    % unterste MOs:
...
plus combination: $e^3 a_1$ and $e^3 b_{1}$ + $e^3 b_{1}$ and $e^3 a_1$ \[ \begin{array}{c}+\left(\text{\begin{tikzpicture}
    % oberste MOs:
    \draw[thick] (0,0) -- (0.5,0); % erster Strich
    \draw[thick] (1,0) -- (1.5,0); % zweiter Strich
    % unterste MOs:
...
minus combination: $e^3 a_1$ and $e^3 b_{1}$ - $e^3 b_{1}$ and $e^3 a_1$ \[ \begin{array}{c}+\left(\text{\begin{tikzpicture}
    % oberste MOs:
    \draw[thick] (0,0) -- (0.5,0); % erster Strich
    \draw[thick] (1,0) -- (1.5,0); % zweiter Strich
    % unterste MOs:
...
plus combination: $e^3 a_1$ and $i^3 b_{1}$ + $i^3 b_{1}$ and $e^3 a_1$ \[ \begin{array}{c}+\left(\text{\begin{tikzpicture}
    % oberste MOs:
    \draw[thick] (0,0) -- (0.5,0); % erster Strich
    \draw[thick] (1,0) -- (1.5,0); % zweiter Strich
    % unterste MOs:
...
minus combination: $e^3 a_1$ and $i^3 b_{1}$ - $i^3 b_{1}$ and $e^3 a_1$ \[ \begin{array}{c}+\left(\text{\begin{tikzpicture}
    % oberste MOs:
    \draw[thick] (0,0) -- (0.5,0); % erster Strich
    \draw[thick] (1,0) -- (1.5,0); % zweiter Strich
    % unterste MOs:
...
plus combination: $e^3 b_{1}$ and $i^3 b_{1}$ + $i^3 b_{1}$ and $e^3 b_{1}$ \[ \begin{array}{c}+\left(\text{\begin{tikzpicture}
    % oberste MOs:
    \draw[thick] (0,0) -- (0.5,0); % erster Strich
    \draw[thick] (1,0) -- (1.5,0); % zweiter Strich
    % unterste MOs:
...
minus combination: $e^3 b_{1}$ and $i^3 b_{1}$ - $i^3 b_{1}$ and $e^3 b_{1}$ \[ \begin{array}{c}+\left(\text{\begin{tikzpicture}
    % oberste MOs:
    \draw[thick] (0,0) -- (0.5,0); % erster Strich
    \draw[thick] (1,0) -- (1.5,0); % zweiter Strich
    % unterste MOs:
