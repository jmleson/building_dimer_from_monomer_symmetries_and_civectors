...
#
#
# def get_linear_combined_states(molecule:Molecule):
...
#                 content += draw(l1, point_group=molecule.get_point_group())
#             else:
...
#                 content += draw(l_plus, point_group=molecule.get_point_group())
#
#                 l2.change_sign()
...
#                 content += draw(l_minus, point_group=molecule.get_point_group())
#
#     return content
